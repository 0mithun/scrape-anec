...
class ScrapeController extends Controller
{
    public $amazonURLS = [
        ...
        "https://www.amazon.com/Going-Own-Way-Gary-Crosby/dp/0385170556/", "https://www.amazon.com/Mennonite-Little-Black-Dress-Memoir/dp/0805092250/",
        "https://www.amazon.com/Giovane-Toscanini-Franco-Zeffirelli/dp/B000YFDP9O",
        "https://images-na.ssl-images-amazon.com/images/I/51i9kU9pkmL._SX332_BO1,204,203,200_.jpg", "https://www.amazon.com/Strangers-Night-Frank-Sinatra/dp/B000002K9M", "https://www.amazon.com/Walk-Hard-Dewey-Two-Disc-Special/dp/B0012IWNZY/",
    ...
    public function amaxonpixel()
    {

        // return 'amazon pixel';
        $threads = Thread::where('amazon_image_path', '!=', '')
            //->where( 'id', '<', 130000 )
            ->get();
    ...
    public function otherpixel()
    {
        $threads = Thread::where('other_image_path', '!=', '')
            //->where( 'id', '<', 130000 )
            ->get();
    ...
    public function wikipixel()
    {
        ...
        $threads = Thread::where('wiki_image_path', '!=','')->where('wiki_image_path_pixel_color', '=', null)
            //->where( 'id', '<', 130000 )
            ->get();
